...
try {
    ...
    $sql = "SELECT ROW_NUMBER() OVER (ORDER BY pug_CSW_USP DESC) AS row_num, nick, pug_CSW_USP FROM basicweapomstats1 LIMIT 15";
    $stmt = $pdo->query($sql);
	...
	echo "<tr>";
        ...
        echo "<td>" . htmlspecialchars($BASIC_POINTS_STATS['pug_CSW_USP']) . "</td>";
        echo "</tr>";
    }
    echo "</table>";
