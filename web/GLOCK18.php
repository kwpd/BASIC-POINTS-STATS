...
try {
    ...
    $sql = "SELECT ROW_NUMBER() OVER (ORDER BY pug_CSW_GLOCK18 DESC) AS row_num, nick, pug_CSW_GLOCK18 FROM basicweapomstats1 LIMIT 15";
    $stmt = $pdo->query($sql);
	...
	echo "<tr>";
        ...
        echo "<td>" . htmlspecialchars($BASIC_POINTS_STATS['pug_CSW_GLOCK18']) . "</td>";
        echo "</tr>";
    }
    echo "</table>";
