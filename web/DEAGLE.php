...
try {
    ...
    $sql = "SELECT ROW_NUMBER() OVER (ORDER BY pug_CSW_DEAGLE DESC) AS row_num, nick, pug_CSW_DEAGLE FROM basicweapomstats1 LIMIT 15";
    $stmt = $pdo->query($sql);
	...
	echo "<tr>";
        ...
        echo "<td>" . htmlspecialchars($BASIC_POINTS_STATS['pug_CSW_DEAGLE']) . "</td>";
        echo "</tr>";
    }
    echo "</table>";
