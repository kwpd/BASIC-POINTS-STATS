...
try {
    ...
    $sql = "SELECT ROW_NUMBER() OVER (ORDER BY pug_CSW_M4A1 DESC) AS row_num, nick, pug_CSW_M4A1 FROM basicweapomstats2 LIMIT 15";
    $stmt = $pdo->query($sql);
	...
	echo "<tr>";
        ...
        echo "<td>" . htmlspecialchars($BASIC_POINTS_STATS['pug_CSW_M4A1']) . "</td>";
        echo "</tr>";
    }
    echo "</table>";
