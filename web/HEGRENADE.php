...
try {
    ...
    $sql = "SELECT ROW_NUMBER() OVER (ORDER BY pug_CSW_HEGRENADE DESC) AS row_num, nick, pug_CSW_HEGRENADE FROM basicweapomstats1 LIMIT 15";
    $stmt = $pdo->query($sql);
	...
	echo "<tr>";
        ...
        echo "<td>" . htmlspecialchars($BASIC_POINTS_STATS['pug_CSW_HEGRENADE']) . "</td>";
        echo "</tr>";
    }
    echo "</table>";
